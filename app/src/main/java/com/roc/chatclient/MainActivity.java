...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestPermissions() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            String[] permissions = {Manifest.permission.READ_PHONE_STATE, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO, Manifest.permission.CAMERA};
            //验证是否许可权限

...
public class EaseConversationAdapater extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MsgToType toType = MsgToType.getType(conversation.getToType());
        if (toType == MsgToType.Group) {
//            String groupId = conversation.getName();
...
//            holder.name.setText(group != null ? group.getGroupName() : username);
        } else if (toType == MsgToType.System) {
//            holder.avatar.setImageResource(R.drawable.ease_group_icon);
...
//            EaseUserUtils.setUserNick(username, holder.name);
        ...
        if (conversation.getAllMsgCount() != 0) {
            ...
            ReceiveMsgInfo lastMessage = conversation.getLastMsg();
            String content = null;
//            if (cvsListHelper != null) {
//                content = cvsListHelper.onSetItemSecondaryText(lastMessage);
//            }

            //EaseSmileUtils.getSmiledText(getContext(), EaseCommonUtils.getMessageDigest(lastMessage, this.getContext()))
//            holder.message.setText(,
//                    BufferType.SPANNABLE);
            Spannable msg = EaseSmileUtils.getSmiledText(getContext(), CommonUtils.getMessageDigest(lastMessage, (this.getContext())));
            holder.message.setText(msg, BufferType.SPANNABLE);
            if (content != null) {
                holder.message.setText(content);
            }
            holder.time.setText(lastMessage.ReceiveTime);

...
import com.roc.chatclient.model.EaseVoiceRecorder;
import com.roc.chatclient.util.CommonUtils;
import com.roc.chatclient.widget.chatrow.EaseChatRowVoicePlayer;
...
public class EaseVoiceRecorderView extends RelativeLayout {
    ...
    private void init(Context context) {
        ...
        wakeLock = ((PowerManager) context.getSystemService(Context.POWER_SERVICE)).newWakeLock(
                PowerManager.SCREEN_DIM_WAKE_LOCK, "com.roc.chatclient:demo");
    }

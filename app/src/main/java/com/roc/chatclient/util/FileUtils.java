...
public class FileUtils {
    ...
    public static void openFile(File var0, Activity var1) {
        ...
        var2.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);//268435456
...
//        var3.setAction("android.intent.action.VIEW");
        var3.setAction(Intent.ACTION_VIEW);
    ...
    public static synchronized File saveFile(String path, String fileName, byte[] bytes) {
        try {

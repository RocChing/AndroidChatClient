...
public class PreferenceManager {
    ...
    private static String SHARED_KEY_CURRENTUSER = "SHARED_KEY_CURRENTUSER";
    ...
    public void setCurrentUser(User user) {
        ...
        editor.putString(SHARED_KEY_CURRENTUSER_AVATAR, user.Avatar);
        editor.putString(SHARED_KEY_CURRENTUSER_NICK, user.NickName);
        editor.putString(SHARED_KEY_CURRENTUSER, json);
        editor.commit();
    }
    ...
    public void removeCurrentUserInfo() {
        editor.remove(SHARED_KEY_CURRENTUSER);
